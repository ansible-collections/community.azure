...
class AzureRMPostgreSqlDatabasesInfo(AzureRMModuleBase):
    ...
    def exec_module(self, **kwargs):
        ...
        if is_old_facts:
            self.module.deprecate("The 'azure_rm_postgresqldatabase_facts' module has been renamed to 'azure_rm_postgresqldatabase_info'", version='3.0.0', collection_name='community.azure')  # was 2.13
