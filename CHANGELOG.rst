...
- community.azure.azure_rm_managed_disk is deprecated. Use azure.azcollection.azure_rm_managed_disk instead (https://github.com/ansible-collections/community.azure/pull/24).
